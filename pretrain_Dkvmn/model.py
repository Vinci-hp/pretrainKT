...
from pretrain_Dkvmn.memory import DKVMN
import numpy as np
...
class MODEL(nn.Module):
    ...
    def __init__(self, n_question, batch_size, q_embed_dim, qa_embed_dim,
        ...
        self.memory_key_state_dim = memory_key_state_dim #50
        self.memory_value_state_dim = memory_value_state_dim #200
        ...
        self.c_embed = nn.Embedding(5, self.q_embed_dim, padding_idx=4)
    ...
    def init_embeddings(self):
        ...
        # nn.init.kaiming_normal_(self.c_embed.weight)
        nn.init.kaiming_normal_(self.qa_embed.weight)

    def forward(self, q_data, qa_data, input_c, input_skill_full, skill, target, pretrain, student_id=None):
        ...
        q_embed_data, _ = pretrain_embedding(pretrain, q_data, input_skill_full)
        qa_embed_data = q_embed_data + self.c_embed(input_c)
        # q_embed_data, qa_embed_data = pretrain_qa_embedding(model=pretrain_qa, question=q_data, skill=input_skill_full, correct=input_c, pretrain_q_model=pretrain)
